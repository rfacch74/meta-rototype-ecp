...
echo "Rototype srl." > strings/0x409/manufacturer
echo "EcpPlatform" > strings/0x409/product
...
mkdir functions/mass_storage.ecpdisk

echo "/dev/mmcblk0p1" > functions/mass_storage.ecpdisk/lun.0/file
echo 0 > functions/mass_storage.ecpdisk/stall
echo 0 > functions/mass_storage.ecpdisk/lun.0/cdrom
echo 0 > functions/mass_storage.ecpdisk/lun.0/nofua
echo 1 > functions/mass_storage.ecpdisk/lun.0/removable
echo "EcpDisk" > functions/mass_storage.ecpdisk/lun.0/inquiry_string
...
ln -s functions/mass_storage.ecpdisk configs/c.1
